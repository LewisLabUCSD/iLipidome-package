#' Website function for lipid species substructure analysis
#' 
...
#' @param non_missing_pct percentage of non-missing values in a biosynthetic pathway 
...
lipid_species_substructure_analysis <- function(exp_raw, method, ctrl, exp,
  ...
  path_score_sel <- path_score[,c('path', 'from', 'to', 'cal_score', 'Type', 'rep_sub_path')]
  ...
  DE_volcano_plot <- species_sub_exp_t %>%
